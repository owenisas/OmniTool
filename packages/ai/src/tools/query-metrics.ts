...
export function makeQueryMetricsTool(userId: string) {
  return tool({
    description:
      "Query performance metrics for a project the signed-in user can access. Returns velocity, completion rate, cycle time, etc.",
